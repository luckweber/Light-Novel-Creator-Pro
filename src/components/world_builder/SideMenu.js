  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 h-full overflow-y-auto">
                  ...
                  <div className="ml-6 mt-1 space-y-1">
                    {subMenu.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <ItemIcon className="h-3 w-3 mr-3" />
      ...
      <div className="p-4 border-t border-gray-200">
        <h3 className="text-sm font-medium text-gray-900 mb-3">Informações Rápidas</h3>
        <div className="space-y-2 text-xs text-gray-600">
          ...
          <div className="flex justify-between">
            <span>Locais:</span>
            <span className="font-medium">{worldData?.locations?.length || 0}</span>
          </div>
          <div className="flex justify-between">
            <span>Povos:</span>
            <span className="font-medium">{worldData?.peoples?.length || 0}</span>
          </div>
          <div className="flex justify-between">
            <span>Sistemas:</span>
            <span className="font-medium">{worldData?.magicSystems?.length || 0}</span>
          </div>
        </div>
      </div>
    </div>
